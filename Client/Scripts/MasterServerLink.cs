...
public sealed class MasterServerLink : Node, IMessageSender
{
    ...
    public static MasterServerLink Instance { get; private set; } = null!;
    ...
    void IMessageSender.SendTo(Message message, Guid receiverId)
    {
